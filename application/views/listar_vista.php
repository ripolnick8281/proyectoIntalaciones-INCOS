    ...
    <main id="fondo1" class="app-content">
      <div id="fondotitulo" class="app-title">
        <div id="contenedortitulo">
          <h1 id="titulo1" ><i class="fa fa-dashboard"></i>Servicios</h1>
          <p></p>
        </div>
            ...
            <div id="colorform" class="tile-body">
              <div id="colorform2" class="table-responsive">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->telefono; ?> </td>
                         <td>
                           ...
                           echo form_open_multipart('welcome/modificar',$atributos)?>
                           <input type="hidden" name="id" value="<?php echo $row->idservicio; ?>">
                         ...
                         <td>
                           <?php
                           $atributos = array('class' => 'form-group', 'id' => 'myform');
                           echo form_open_multipart('welcome/eliminarservicio',$atributos)?>
                           <input type="hidden" name="id" value="<?php echo $row->idservicio; ?>">
                ...
                <?php 
                 ...
                 echo form_open_multipart('welcome/registrar', $atributos); ?>
                 <button type="submit" class= "btn btn-info btn">Agregar Cliente</button>
                 <?php
                 echo form_close();
                ?>
              </div>
